---
source_url: https://www.kodeco.com/36875585-how-to-write-the-perfect-resume-after-graduating-a-coding-bootcamp
crawl_depth: 0
crawled_at: 2026-05-05T08:28:20Z
word_count: 1555
---

Group Group Group Group Group Group Group Group Group Group Shape Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group Group
[ ![ads via Carbon](https://srv.carbonads.net/static/30242/f3dc6d2c4c4ea6771977d883b7a49937b048390f) ](https://srv.carbonads.net/ads/click/x/GTND427UCAAIE23MCWALYKQUCASIC537CASILZ3JCASI52QLCT7DE53KC6BIC23UF6YIVKQIC6ADE5QNFTSI4KJIHEYI527UF6BITK3ECTNCYBZ52K) [ Get the Drop. Weekly front-end tools, tips, and resources. Plus a free icon pack to get you started. ](https://srv.carbonads.net/ads/click/x/GTND427UCAAIE23MCWALYKQUCASIC537CASILZ3JCASI52QLCT7DE53KC6BIC23UF6YIVKQIC6ADE5QNFTSI4KJIHEYI527UF6BITK3ECTNCYBZ52K)
![ads via Carbon](https://insight.adsrvr.org/track/pxl/?adv=t3k9qrj&ct=0:djrfa1z&fmt=3&orderid=&v=)![ads via Carbon](https://ad.doubleclick.net/ddm/activity/src=15643656;type=sales;cat=408690;qty=1;cost=\[Revenue\];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;npa=;gdpr=$;gdpr_consent=$;ord=\[OrderID\])![ads via Carbon](https://sp.analytics.yahoo.com/spp.pl?a=10000&.yp=10207075&he=&hph=&gv=\[ORDER_VALUE\]&orderId=\[ORDER_ID\]&ec=\[EVENT_CATEGORY\]&ea=fire&el=\[EVENT_LABEL\])![ads via Carbon](https://secure.adnxs.com/seg?add=37012073&t=2)![ads via Carbon](https://secure.adnxs.com/px?id=1777282&t=2%0A)![ads via Carbon](https://segment.prod.bidr.io/associate-segment?buzz_key=dsp&segment_key=dsp-19102)![ads via Carbon](https://cnv.event.prod.bidr.io/log/cnv?tag_id=3503&buzz_key=dsp&value=&account_id=79&order=\[ORDER\]&ord=\[CACHEBUSTER\])
So you’ve graduated from a [coding bootcamp](https://store.kodeco.com/bootcamp) and you’re ready to start applying for developer jobs. You’re now in the unenviable position of having the skills you need for a job, but no work experience yet. How do you put everything you’ve learned during your bootcamp on your resume? What about your previous work experience? How can you set yourself apart from other recent graduates?
Are you looking to break into the tech industry? “Hack Your Job Search: An Authoritative Guide to Landing Your First Dev Interview” offers insider tips and advice you won’t find anywhere else!  
...
[![Mobile dev resume with the format described in this article](https://files.koenig.kodeco.com/uploads/2028/11/Sample-Resume-247x320.png)](https://files.koenig.kodeco.com/uploads/2028/11/Resume_Example_Kodeco.pdf)
Sample resume for bootcamp graduates. (c)Jay Strawn. Click to enlarge.
...
_Example_ :
  * _Coding Languages_ : Swift, Objective-C, SwiftUI, Dart, Kotlin, Java, HTML, CSS
  * _Spoken Languages_ : English (Fluent), Spanish (Intermediate)
  * _Frameworks_ : REST APIs, Web Sockets, Unit Testing, Push Notifications, AVFoundation, ARKit, Git Version Control, Firebase, CocoaPods, Swift Package Manager, Apple Maps, Google Maps, Core Location, Core Data
  * _Tools_ : XCode, Instruments, Android Studio
...
Note that after you get your first job in tech, you should put your employment history _above_ your projects, because relevant work experience is the most important thing you can show. But if you don’t have any experience in tech yet, what’s most important is showcasing your tech skills at the top of your resume.
...
_Example_ :
  * _Kitty To-Do List — Available on the App Store_  
In this app, I use Core Data to store user-defined tasks in the app and display the tasks in a UICollectionView with custom cells. I use AVAudioSession to play a randomized clip of a “meow” when the user marks a task as done. The app features image caching, uses Codable to parse JSON from an API and includes both English and Spanish localization.
  ...
  * _Find Nearby Coffee — Available on the App Store_  
