...
The first one is hard to believe just because programming is not only about math and logical concepts: it requires creativity and for AI it's something that the most used service providers like ChatGPT, Claude, or Gemini are not doing as well as humans (Some people can disagree with this statement but have you seen something truly magical made 100% by IA lately? Be honest). There are some problems related to performance, too: [Uplevel's research](https://resources.uplevelteam.com/gen-ai-for-coding?utm_campaign=newsletter_q4_2024&utm_medium=email&_hsenc=p2ANqtz-_55yuzrAq33-lAoVDmNJW_MygVEt9X4D4yQMqQfr8pXd2Gxr7a3u6e8-135cEkbxWSgXLZnELldfb_1vdEY_YpvxU9yw&_hsmi=338856122&utm_content=338856122) "Gen AI for Coding Research" found a negative impact on the codebase (41% higher bug rate) among other issues. AI may speed things up, but it's not a silver bullet, and the market is trying to understand it.
...
![None](https://miro.medium.com/v2/resize:fit:700/1*6rziykTjkpAUkziugsTgoA.png)
...
![None](https://miro.medium.com/v2/resize:fit:700/1*K1hZ6doh8fYrSkaU-Jyv4A.png)
...
![None](https://miro.medium.com/v2/resize:fit:700/1*WxsWSYjWQltcxGjapaSKSg.png)
