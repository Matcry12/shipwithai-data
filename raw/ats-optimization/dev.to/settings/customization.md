---
source_url: https://dev.to/settings/customization
...
[ ![DEV Community](https://dev-to-uploads.s3.amazonaws.com/uploads/logos/original_logo_0DliJcfsTcciZen38gX9.png) ](https://dev.to/)
#  Join the DEV Community 
DEV Community is a community of 3,879,109 amazing developers 
* * *
OR
By signing in, you are agreeing to our [privacy policy](https://dev.to/privacy), [terms of use](https://dev.to/terms) and [code of conduct](https://dev.to/code-of-conduct). 
* * *
New to DEV Community? [Create account](https://dev.to/enter?signup_subforem=1&state=new-user). 
