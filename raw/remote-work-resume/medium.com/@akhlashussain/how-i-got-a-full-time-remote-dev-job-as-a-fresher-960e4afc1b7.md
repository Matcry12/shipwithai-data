...
I wanted to enter a company as a ***fresher*** where I would be able to ***learn and work*** on the ***latest tech*** and we all know ***JavaScript is here to stay 🔥R*****. Now let's start with some things that I did in my last year of college that helped me get the role.**
...
### We all are stuck somewhere after learning HTML, CSS, and JavaScript and we want to become better but we don’t know what…

medium.com](https://medium.com/@akhlashussain/become-better-at-frontend-development-by-doing-this-7d755c3e0daa)
...
![None](https://miro.medium.com/v2/resize:fit:700/1*zJ6ZGhT9t5rSsOeQwVQZyQ.png)
...
### Search through thousands of startup jobs, across any location or remote, hiring for software engineers, product…
...
![None](https://miro.medium.com/v2/resize:fit:700/1*gCiUC8dPgJl7PVBlZZrftw.png)

"Grind" generated using AI

If there's anything you guys want me to write or write a specific blog on a topic, comment below. I will write more blogs on the same. Thanks for the read ✌️

***Until next time …***

### Need help with preparing and applying ? Book a call now 👇🏻

[## 1:1 Call (Resume Review + QnA + Tips) with Mohammed Akhlas Hussain

### A Software Engineer who is currently working in an AI startup.

topmate.io](https://topmate.io/akhlas/1240063)

![None](https://miro.medium.com/v2/resize:fit:700/1*OSRz40mFflAU1zoFpHcz-w.jpeg)
