...
![_key_git_concepts_commands.webp](https://media.geeksforgeeks.org/wp-content/uploads/20260423170941657742/_key_git_concepts_commands.webp)
![git_hosting_platforms_wrap_up_.webp](https://media.geeksforgeeks.org/wp-content/uploads/20260423170941468602/git_hosting_platforms_wrap_up_.webp)
![aaa.webp](https://media.geeksforgeeks.org/wp-content/uploads/20260423170942070358/what_is_git_.webp)
Previous Pause Next
## Introduction to Git
...
This section covers Git integration in CI/CD pipelines, including Jenkins setup, GitLab workflows for different languages and hosting private Git servers on Kubernetes.
  * [CI/CD in Java application(Linux) Using Shell and Docker Executor on GitLab](https://www.geeksforgeeks.org/java/implementation-of-ci-cd-in-java-applicationlinux-using-shell-and-docker-executor-on-gitlab/)
  * [CI/CD in C/C++ Application(Linux) Using Shell and Docker Executor on GitLab](https://www.geeksforgeeks.org/cpp/implementation-of-ci-cd-in-c-c-applicationlinux-using-shell-and-docker-executor-on-gitlab/)
