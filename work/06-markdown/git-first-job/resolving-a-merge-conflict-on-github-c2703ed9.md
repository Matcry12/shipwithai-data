...
signal_score: 1.0
status: kept
core_question: How do you resolve a merge conflict on GitHub caused by competing line changes?
tldr: Guide to resolving merge conflicts on GitHub when competing line changes occur, including using
  Copilot, marking conflicts resolved, and committing merges.
key_topics:
- merge conflicts
- GitHub
- pull requests
...
- Copilot
entities:
  primary: GitHub merge conflict resolution
  aliases:
  - merge conflicts on GitHub
  - resolving competing line changes
  - GitHub pull request conflicts
content_hash: sha256:f07399c56e821a82584d2120938e859dc5126ee8fe35f7b6d08edc323407b225
---
