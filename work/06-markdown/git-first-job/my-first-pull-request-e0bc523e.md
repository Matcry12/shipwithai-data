...
signal_score: 1.0
status: kept
core_question: How do you create and submit your first pull request on GitHub?
tldr: Tutorial on how to contribute to GitHub projects through pull requests covering forking, branching,
  editing, and submitting code changes for review and merging.
key_topics:
- pull request
- GitHub workflow
- forking
...
- code contribution
entities:
  primary: GitHub pull requests
  aliases:
  - code contribution
  - git workflow
  - GitHub collaboration
content_hash: sha256:f91c584b019291084b79e5a1303e39cb2e1475a71a748dacf15ba3f1e20a3163
---
