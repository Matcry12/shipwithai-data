...
signal_score: 1.0
status: kept
core_question: What is the standard structure for commit messages that enables automated tooling and clear
  version history?
tldr: Specification for conventional commit message format that provides explicit commit history structure
  for automated tools and semantic versioning.
key_topics:
- commit format
- semantic versioning
- breaking changes
...
entities:
  primary: Conventional Commits specification
  aliases:
  - commit message convention
  - semantic commits
  - commit formatting
content_hash: sha256:2b061ecf9793951c4c5b94026d7697cfe700df444b3d370eb70758b0966975ce
---
