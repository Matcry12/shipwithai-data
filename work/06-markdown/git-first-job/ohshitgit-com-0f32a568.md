---
title: Oh Shit, Git!?!
source_url: https://ohshitgit.com/
source_domain: ohshitgit.com
topic: git-first-job
doc_type: how-to-guide
published_date: '2025-01-01'
fetched_at: '2026-05-25T06:40:32.503520+00:00'
language: en
word_count: 1279
reading_time: 7
signal_score: 1.0
status: kept
core_question: How do you recover from common git mistakes and problems in plain English?
tldr: Practical plain-English guide to fixing common git mistakes, from time travel with reflog to undoing
  commits and recovering deleted work.
key_topics:
- git
- reflog
- reset
...
- error recovery
entities:
  primary: Git error recovery guide
  aliases:
  - git troubleshooting
  - git mistakes
  - git help
  - undo git commits
content_hash: sha256:d83a8ec653d04a40b51d2e2666dd52034f2a68455624b8019d3e37d972cb1c7f
---
...
This usually happens to me if I commit, then run tests/linters... and FML, I didn't put a space after an equals sign. You could also make the change as a new commit and then do `rebase -i`
...
Note: this doesn't work if you've already pushed the commit to a public/shared branch, and if you tried other things first, you might need to `git reset HEAD@{number-of-commits-back}`

instead of `HEAD~`

. Infinite sadness. Also, many many many people suggested an awesome way to make this shorter that I didn't know myself. Thank you all!
...
When I finally figured this out it was HUGE. HUGE. H-U-G-E. But seriously though, on what fucking planet does `checkout --`

make sense as the best way to undo a file? :shakes-fist-at-linus-torvalds:
...
Thanks to Eric V. for this one. All complaints about the use of `sudo`

in this joke can be directed to him.
