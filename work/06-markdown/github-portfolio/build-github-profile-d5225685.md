...
tldr: Guide to optimizing GitHub profile for job search through repository pinning, professional setup,
  project READMEs, contribution tracking, and portfolio curation.
key_topics:
- GitHub optimization
- pinned repositories
- profile README
...
entities:
  primary: GitHub profile for job search
  aliases:
