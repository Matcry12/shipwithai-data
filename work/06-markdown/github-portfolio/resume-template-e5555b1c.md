...
source_url: https://github.com/topics/resume-template
source_domain: github.com
topic: github-portfolio
doc_type: reference
published_date: '2026-05-01'
fetched_at: '2026-05-25T06:39:35.500777+00:00'
language: en
word_count: 251
reading_time: 2
signal_score: 0.7092
status: kept
core_question: What open-source tools are available for building resumes as code?
tldr: OpenResume open-source resume builder and parser allowing resume creation in Markdown with support
  for academic portfolios, BibTeX, and multiple output formats.
key_topics:
- resume builder
- open source
- Markdown
...
- resume parser
entities:
  primary: open-source resume builder
  aliases:
  - resume builder tool
  - Markdown resume
content_hash: sha256:bfadf6acf1eafe834e60a08a75ee3899e3d807cb27de7df41c7a5720a1691127
---
...
Add a description, image, and links to the resume-template topic page so that developers can more easily learn about it.

To associate your repository with the resume-template topic, visit your repo's landing page and select "manage topics."
