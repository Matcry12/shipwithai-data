...
signal_score: 1.0
status: kept
core_question: What qualifications and experience does a senior backend engineer role require?
tldr: Job posting for senior backend engineer role with Elixir, Phoenix, PostgreSQL, AWS, and React/Next.js
  tech stack, emphasizing async work and diverse team collaboration.
key_topics:
- job posting
- backend engineer
- Elixir
...
- AWS
entities:
  primary: Senior Backend Engineer job
  aliases:
  - backend role
  - Elixir engineer
  - remote backend position
content_hash: sha256:54a8a01e8e50967a47e0f6e53bc1c25ce49accb6bb905dd7c569529a3d3c09bc
---
