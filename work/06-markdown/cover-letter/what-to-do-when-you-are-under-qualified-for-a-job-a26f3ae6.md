---
title: What to Do When You Are Under-Qualified For a Job
source_url: https://vault.com/blogs/job-search/what-to-do-when-you-are-under-qualified-for-a-job
source_domain: vault.com
topic: cover-letter
doc_type: how-to-guide
author: Vault Careers
published_date: '2011-08-02'
fetched_at: '2026-05-25T06:42:59.103781+00:00'
language: en
word_count: 639
reading_time: 4
signal_score: 1.0
status: kept
core_question: How should you apply for jobs when you don't meet all the qualifications?
tldr: Actionable advice for underqualified job candidates including not giving up, strengthening resume
  and cover letter, researching companies, highlighting transferable skills, and gaining relevant experience
  through internships or unpaid trial work.
key_topics:
- job search
- career development
- resume
...
- self-promotion
entities:
  primary: Underqualified for job
  aliases:
  - job requirements gap
  - qualification mismatch
  - career advancement
content_hash: sha256:72f4759bc310b35dc058fda169f3fce5504e0cbfd814f37431764836d8d3c001
---
...
**Don't Give Up Hope.** The required qualifications portion of a job posting is more like a wish list from the employer and should in no way deter someone from applying for the position. If you are a few years shy of the required experience, but feel you can do the job, apply. The worst they can say is no. You already had a no by not applying at all.
