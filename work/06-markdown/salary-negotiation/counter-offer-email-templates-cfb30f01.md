...
fetched_at: '2026-05-25T06:48:07.200876+00:00'
language: en
word_count: 3062
reading_time: 16
signal_score: 1.0
status: kept
core_question: How should professionals compose counter offer emails to negotiate higher compensation?
tldr: 15 copy-paste email templates for salary negotiation and counter offers with data-driven strategies
...
entities:
  primary: counter offer email templates
  aliases:
  - salary negotiation
  - offer negotiation
  - counter offer email
content_hash: sha256:07c00331dedccd7181a59fee7ee1633a0a8500799df032801d069e5087c5486c
---
...
**Before you send one**, run our free Negotiation Readiness Scanner — it scores how prepared you are across the eight signals recruiters actually probe (your floor, your walk-away, your alternatives, your justification) so you know exactly where you'll fumble if pushed back on your number.
...
**Subject line**that's clear and professional**Opening**with gratitude and enthusiasm**Acknowledgment**of the specific offer**Your counter**with specific number**Reasoning**backed by data or value**Flexibility signal**showing you want to find agreement**Next step**proposing how to move forward
...
Sign-on bonus:Would a $[X] sign-on bonus be possible?Equity:Could the equity grant be increased from [X shares] to [Y shares]?Performance review:Would you consider an accelerated 6-month review with potential salary adjustment?PTO:Could we adjust from [X days] to [Y days]?I'm genuinely excited about this opportunity and want to find a path forward that works for everyone.
...
Compensation:The offer of $[X] is based on [Company City] salary bands. Given that I'll be working from [Your City] and bringing experience from the [Your Market] job market (where I've been compensated at $[Previous Salary]), I was hoping for compensation closer to $[Your Target].I understand companies have different approaches to remote compensation. I'm open to discussing how [Company Name] thinks about this and finding a solution that works.
