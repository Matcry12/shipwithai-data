---
title: 'How to List Ongoing Education on a Resume: Examples and Expert Tips'
source_url: https://enhancv.com/blog/continuing-education-on-resume/
source_domain: enhancv.com
topic: executive-resume
doc_type: how-to-guide
author: Gratsiela Borisova
published_date: '2022-01-28'
fetched_at: '2026-05-25T06:38:32.140829+00:00'
language: en
word_count: 1070
reading_time: 6
signal_score: 1.0
status: kept
core_question: How should job seekers list ongoing education and in-progress degrees on their resumes?
tldr: Guide on how to list ongoing education, in-progress degrees, and continuing education courses on
  resumes with proper formatting and examples.
key_topics:
- ongoing education
- in-progress degree
- certifications
...
- resume formatting
entities:
  primary: continuing education on resume
  aliases:
  - in-progress degree
  - ongoing education
  - professional development resume
content_hash: sha256:0a700a67818ab7e2a75393c099d2c574fd2332900e5a18437f81caeba58671ce
---

# How to List Ongoing Education on a Resume: Examples and Expert Tips

Learning doesn't end once your career begins—and your resume shouldn't make it seem that way. Mentioning education in progress shows employers you're growing, staying current, and actively investing in your skills.
...
**Students or graduates:**List education near the top, before experience.**Experienced professionals:**Position it after Work History or in a smaller Education section.**Short courses or certificates:**Group them under*Professional Development*or*Certifications*.
...
**Start****with your degree or program name:**Use the official title of your degree or course.*For example:*Bachelor of Science in Marketing**Add your institution and location:**Include the university or organization and city.*For example:*University of Denver, Denver, CO**Include your start date and mark it as "Expected [Month Year]" or "In Progress":**This gives employers a clear sense of your timeline.*For example:*Expected May 2026**Add key coursework or honors only if they strengthen your application:**Choose details that connect directly to the role you want.*For example:*Coursework: Consumer Behavior, Marketing Analytics**Keep the layout consistent:**Match the style and formatting of your other resume sections for a unified, polished look.**Focus on what's most relevant:**Highlight achievements, projects, or subjects that demonstrate skills useful in your next role.
...
**Use a clear section title:**Label it*Continuing Education*,*Professional Development*, or*Certifications*—choose what fits your resume style best.**Add the course or program name:**Include the official title of the course or credential.*For example:*Advanced Excel for Business**Include the provider and completion status:**Mention the organization and note "In Progress" or "Expected [Month Year]."*For example:*Coursera — In Progress**Summarize the focus or result:**Add one short phrase about what the course covers or what skill you're developing.*For example:*Ongoing coursework in project management and agile methodology.**Keep it brief:**One to three entries are plenty. Focus on what supports your current goals.
