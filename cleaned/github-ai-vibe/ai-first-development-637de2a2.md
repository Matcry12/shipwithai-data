---
title: A field guide to AI-first development
...
signal_score: 1.0
status: kept
core_question: A field guide to AI-first development?
tldr: Detailed techniques and prompts for AI-first coding, for experienced developers to build medium-sized
  production-ready codebases, providing lots of architecture-level product guidance but without writing
  a line of code by hand. Want to know how to build a well-architected 60,000-line project from scratch
  in 6 weeks, without writing a single line
key_topics:
- documentation
- testing
- automation
...
- debugging
entities:
  primary: AI-first development
  aliases: []
content_hash: sha256:191551c98992f6c7168bafd15de63b69bcbe0280deb479b3941d25cc9a473257
---
