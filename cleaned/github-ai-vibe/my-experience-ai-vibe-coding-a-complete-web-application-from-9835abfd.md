...
source_url: https://techhub.iodigital.com/articles/my-experience-ai-vibe-coding-a-complete-web-application-from-scratch
source_domain: techhub.iodigital.com
topic: github-ai-vibe
doc_type: how-to-guide
author: Dave Bitter
published_date: '2025-05-27'
fetched_at: '2026-05-29T13:38:19.233877+00:00'
language: en
word_count: 2351
reading_time: 12
signal_score: 1.0
status: kept
core_question: How to my experience ai vibe coding a complete web application from scratch?
tldr: My experience AI *vibe coding* a complete web application from scratch
key_topics:
- AI
- vibe coding
entities:
  primary: My experience AI vibe coding a complete web application from scratch
  aliases: []
content_hash: sha256:7ea23d7e03ae06cfdc792cca9d3aa12c6e9581b3bceb0adee5c786621d496bcd
---

# My experience AI vibe coding a complete web application from scratch
...
I ended with using Cursor for this. Cursor is an AI code editor that I've been trying out recently. Even though I now have the paid version, I used the free version for this challenge. Which model did I use? I have ab-so-lutely no idea. That's the point. Can someone who is not as much into AI build something cool as well using one of these tools?
...
You can try it yourself over at paxaura.davebitter.com! Curious about the source code it generated? Head over to github.com/DaveBitter/paxaura.
...
And now what? I get to use my breathing exercise app every time I hear somebody say I will be out of a job as I can just be replaced. Nice!
