---
title: Use Agent Mode - Visual Studio (Windows)
...
signal_score: 1.0
status: kept
core_question: What is use agent mode - visual studio (windows)?
tldr: Use Agent Mode - Visual Studio (Windows) With the GitHub Copilot agent mode in Visual Studio, you
  can use natural language to specify a high-level task AI creates a plan, makes code edits, runs terminal
  commands, invokes tools, and applies changes across your codebase It monitors outcomes, such as build
key_topics:
- github copilot
- natural language
- ai model
...
entities:
  ...
  aliases:
  - github copilot
content_hash: sha256:bcffb4be39f29c084b9353dafaa37e2a29d8692e6a8f5f5ef085249856783800
---
