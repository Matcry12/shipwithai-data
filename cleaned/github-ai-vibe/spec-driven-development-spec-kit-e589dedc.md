...
source_url: https://developer.microsoft.com/blog/spec-driven-development-spec-kit
source_domain: developer.microsoft.com
topic: github-ai-vibe
doc_type: how-to-guide
author: Den Delimarsky
published_date: '2025-09-15'
fetched_at: '2026-05-29T13:37:43.860488+00:00'
language: en
word_count: 2018
reading_time: 11
signal_score: 0.9642
status: kept
core_question: How does Spec Kit implement spec-driven development and why is it valuable for AI-assisted
  coding?
tldr: Comprehensive guide to GitHub's Spec Kit, explaining spec-driven development as a lightweight approach
  to capturing requirements and technical decisions that evolve with code.
key_topics:
- Spec Kit
...
content_hash: sha256:a5f633039e11a5c8da601782cc03b62a67cf3a6ff4f29e452d40b16e5b478607
---
...
**Specify CLI**. A helper CLI that bootstraps your projects for SDD. It downloads the official templates from the GitHub repo for the coding agent and platform of your choice and sets up the SDD scaffolding in a way that the agent can start iterating on it.**A set of templates and helper scripts**. This establishes the foundation for our SDD experience. Templates define what a spec looks like, what a technical plan encompasses for a given project, and how all of this is broken down into individual tasks that an AI agent can pick up and execute.
...
Once Specify bootstraps the project, you will see two new folders created within your project – `.github`
...
folder contains all of the SDD templates, such as the ones for the spec, technical plan, and tasks, along with the scripts for the platform you chose. The agent-specific folder, such as `.github`

for GitHub Copilot, will contain the prompt definitions that can help you follow the SDD process without manually typing the actual process requirements. Agent-specific prompts can also most commonly be used through slash commands – in our case, `/specify`

, `/plan`

, and `/tasks`

In addition to the above, GitHub Spec Kit introduces an extra file that you might not have seen before – `constitution.md`
...
And of course – the helper scripts that are in the `powershell`
...
Each slash command has to be used sequentially – first, you create the spec with `/specify`

. Then, you establish the technical requirements with `/plan`

. Next, you break this down into manageable chunks with `/tasks`
...
As you go through individual steps, your AI agent will create new artifacts within the `specs`
