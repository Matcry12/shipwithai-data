...
source_url: https://code.visualstudio.com/blogs/2025/02/24/introducing-copilot-agent-mode
source_domain: code.visualstudio.com
topic: github-ai-vibe
doc_type: how-to-guide
published_date: '2025-02-24'
fetched_at: '2026-05-29T13:37:37.670314+00:00'
language: en
word_count: 1369
reading_time: 7
signal_score: 1.0
status: kept
core_question: How to introducing github copilot agent mode (preview)?
tldr: February 24, 2025 by Isidor Nikolic
key_topics:
- AI
- GitHub
- GitHub Copilot
...
- development
entities:
  primary: Introducing GitHub Copilot agent mode (preview)
  aliases:
  - AI
  - coding
  - development
content_hash: sha256:cfe35d1e4db7bcb48156ce8bfc55147ab888c4340d797f5fd91c1708c90b10a8
---
...
Agent mode is now available in VS Code Stable and has support for MCP servers. Read more about the updates to agent mode in our blog post.
...
In VS Code Insiders, open the Copilot Edits view (unassigned), select **Agent** from the mode dropdown, and enter your prompt.
...
Copilot agent mode automatically finds the precise context and sets the working set of files by calling the right workspace tools. To more precisely guide Copilot, you can always explicitly reference context with `#file`

, using drag and drop or by clicking on the **Add Files** button. For example, you can create a `specifications.md`

file and add it as context to better control Copilot, or you can set custom instructions - so Copilot respects your coding guidelines or other preferences.
...
Each tool has detailed instructions for the LLM on how and when to use it. Here's the `read_file`

tool description as an example:
...
For a detailed overview of Copilot agent mode please read the official docs.
