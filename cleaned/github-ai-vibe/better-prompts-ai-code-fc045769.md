...
signal_score: 1.0
status: kept
core_question: How to write better prompts for AI code generation?
tldr: 'Table of contents - Be specific with language and requirements - Include examples and constraints
  - Break down complex tasks and iterate - Avoid common prompting pitfalls - Graphite Agent: AI code review
  for quality and consistency(graphites-Graphite Agent-ai-code-review-for-quality-and-consistency) Large
  language models (LLMs) can generate code in many programming languages, but'
key_topics:
- code generation
- prompt engineering
- llm
...
entities:
  primary: How
  aliases: []
content_hash: sha256:cb0e19a9f63f4771a73bf4674b3a9e8ca086401ad3214f9b2fb5e0c7945c9464
---
