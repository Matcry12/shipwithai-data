---
title: 'Comparison: Claude vs Cursor vs Copilot Review from a regular coder - Discussions - Cursor'
...
signal_score: 1.0
status: kept
core_question: 'Comparison: Claude vs Cursor vs Copilot Review from a regular coder - Discussions - Cursor?'
tldr: 'Hi. This is just meant as a review and is not to bash on any AI products. Anyway, here is my review:
  So I''ve been using Cursor, ChatGPT, Copilot, and now Claude for a while now. At first, I started using
  ChatGPT because it was a new AI tool that'
key_topics:
- testing
- technical debt
- code quality
...
entities:
  primary: AI tools
  aliases: []
content_hash: sha256:bb736719231702036acbd201a3307ab28b1241d4c38783cb69c7d816c89a8ad1
---

# Comparison: Claude vs Cursor vs Copilot Review from a regular coder - Discussions - Cursor
