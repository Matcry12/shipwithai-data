...
source_domain: addyosmani.com
topic: github-ai-vibe
doc_type: how-to-guide
author: Addy Osmani
published_date: '2026-01-13'
fetched_at: '2026-05-29T13:37:24.005746+00:00'
language: en
word_count: 7156
reading_time: 36
signal_score: 0.9774
status: kept
core_question: How to write a good spec for AI agents?
tldr: 'How to write a good spec for AI agents # How to write a good spec for AI agents ## January 13,
  2026 **TL;DR: Aim for a clear spec covering just enough nuance (this may include structure, style, testing,
  boundaries) to guide the AI without overwhelming it. Break large tasks'
key_topics:
- ai
- coding
- development
...
entities:
  ...
  - write
  - good
content_hash: sha256:d36467378e55028a1306024d301205e72e755ce9cbb2846fc8f87102c045ba15
---
...
**1. Commands:** Put executable commands early - not just tool names, but full commands with flags: `npm test`
...
**3. Project structure:** Where source code lives, where tests go, where docs belong. Be explicit: "`src/`

for application code, `tests/`
...
|---|---|---|
Strengths |
Simpler setup; lower overhead; easier to debug and follow | Higher throughput; handles complex interdependencies; specialists per domain |
Challenges |
Context overload on big projects; slower iteration; single point of failure | Coordination overhead; potential conflicts; needs shared memory (e.g., vector DBs) |
Best For |
Isolated modules; small-to-medium projects; early prototyping | Large codebases; one codes + one tests + one reviews; independent features |
Tips |
Use spec summaries; refresh context per task; start fresh sessions often | Limit to 2-3 agents initially; use MCP for tool sharing; define clear boundaries |
