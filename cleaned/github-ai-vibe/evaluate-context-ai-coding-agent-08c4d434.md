...
signal_score: 1.0
status: kept
core_question: What does writing involve in software development?
tldr: 'Writing AI coding agent context files is easy. Keeping them accurate isn''t. # Writing AI coding
  agent context files is easy. Keeping them accurate isn''t. In previous posts, I explored how context
  reduces coding agent unpredictability. But there''s a problem I didn''t address: **maintenance**. AI
...
entities:
  ...
  - coding
  - agent
content_hash: sha256:52654000ac92049b83e2c381f9dab2cecf45de24819652db19bea43b69faa60a
---
