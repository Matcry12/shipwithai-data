---
title: "Resume Keywords: How to Find the Right Words to Beat the ATS"
...
career_level:
  ...
  - senior
  - executive
source_url: "https://www.coursera.org/articles/resume-keywords"
source_domain: "www.coursera.org"
word_count: 1699
text_to_link_ratio: 0.865
signal_score: 0.865
is_curated: false
tags:
  - ats
...
Written by Coursera Staff • Updated on Jun 11, 2025
...
![\[Featured Image\] A person is at home wearing a green dress and is holding papers and a pen to their chin.  ](https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://images.ctfassets.net/wp1lcwdav1p1/5GKv6azeRBUdpVJN8kCJKB/bc6205d6039d0b0070ea759f44a5fa12/4oC_I2HQ.jpeg?w=1500&h=680&q=60&fit=fill&f=faces&fm=jpg&fl=progressive&auto=format%2Ccompress&dpr=1&w=1000)
Your [resume](https://www.coursera.org/articles/how-to-make-a-resume-for-your-first-job-template) is the gateway to a new career and professional advancement. To ensure your resume puts your best foot forward, you’ll need to impress hiring managers and application filtering software, too. 
Today, approximately 98.4 percent of Fortune 500 companies use an applicant tracking system (ATS) and/or recruiting management system (RMS) to streamline their hiring processes [[1](https://www.jobscan.co/blog/99-percent-fortune-500-ats/)]. These systems track applicants at every stage of the hiring process, manage applicant pools, and filter applications using keywords.
Resume keywords are the key to improving your application’s chances of being seen by an employer. Explore how the ATS and RMS comb through resumes, and learn tips for identifying the keywords that could help you land your next [job](https://www.coursera.org/articles/how-to-get-a-job-with-no-experience).
...
Unfortunately, it is not possible to know the exact criteria that a hiring manager will use to filter resumes. While some focus on specific skills like [project management](https://www.coursera.org/articles/what-is-project-manager), others focus on specific credentials, such as a [bachelor’s degree](https://www.coursera.org/articles/what-is-a-bachelors-degree). Some might pick something else entirely. That’s where ATS resume keywords come in.
### Why do you need ATS resume action words?
...
For example, consider the following qualifications from a real job listing advertising a [data analyst](https://www.coursera.org/articles/what-does-a-data-analyst-do-a-career-guide) position. To identify relevant keywords and phrases, the applicant might go through the job description and bold the [skills and experience](https://www.coursera.org/articles/transferable-skills) that match their own. 
...
**Basic qualifications:**
  * 3+ years of experience working with databases, writing structured query language (SQL), Excel, and Salesforce


  * Demonstrated experience synthesizing data and building reports


  * Experience in the technology industry or a comparable fast-paced industry
...
**Preferred Qualifications:**
  * Bachelor’s degree in finance, statistics, economics, data analytics, business, or a related field


  * Experience with R, Python notebooks, and Google Sheets


  * Expertise in any or all of these areas: Technology (ex. computer science), business (ex. marketing, finance), and health (ex. patient care, pharma)
...
Now that you have identified the skills and experience in the job description that match your own, you should add them to a list organized by “work experience” and “skills.” The purpose here is to create a list that includes the exact phrasing used in the job description because the system will likely search for matching terms using the same language. 
...
• Synthesizing data   
• Building reports   
• Experience in a commercial team focusing on clients/partner needs   
• Bachelor’s degree in business  | • SQL   
• Excel   
• Salesforce   
• Python notebooks   
• Teamwork   
...
### 4. Apply and repeat resume power words for other job postings. 
...
## Develop in-demand skills to boost your resume with Coursera
Using the right keywords is one way to make your resume stand out from other potential candidates. You might consider obtaining a [Professional Certificate](https://www.coursera.org/professional-certificates) to get job-ready by building in-demand skills as you search for a new job. Coursera offers over 10,000 courses in a wide range of subjects offered by more than 350 world-class universities and organizations, such as [Google](https://www.coursera.org/professional-certificates/google-data-analytics), [Stanford](https://www.coursera.org/learn/machine-learning), and the [University of Michigan](https://www.coursera.org/degrees/mph-umich).
![Google](https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/http://coursera-university-assets.s3.amazonaws.com/92/d0d1ee4a844037be9a2d349ee5f59d/GoogleG_FullColor_RGB.png?auto=format%2Ccompress&dpr=1&w=60&h=60&q=40)
professional certificate
...
4.9
(32,325 ratings)
1,180,120 already enrolled
Beginner level
Average time: 33 hour(s)
Learn at your own pace
## Article sources
  1. JobScan. “[2024 Applicant Tracking System (ATS) Usage Report: Key Shifts and Strategies for Job Seekers](https://www.jobscan.co/blog/99-percent-fortune-500-ats/), https://www.jobscan.co/blog/99-percent-fortune-500-ats/.” Accessed June 3, 2025. 
