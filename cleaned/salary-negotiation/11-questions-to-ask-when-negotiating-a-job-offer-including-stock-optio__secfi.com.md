---
title: "11 questions to ask when negotiating a job offer including stock options"
topic: "salary-negotiation"
career_level:
  - mid
source_url: "https://secfi.com/learn/how-to-negotiate-a-job-offer-stock-options"
source_domain: "secfi.com"
word_count: 1306
...
doc_type: "reference"
core_question: "What questions should you ask about stock options to understand their true value?"
tldr: "Eleven key questions to ask about stock options when negotiating a job offer, covering strike price, vesting, dilution, and post-employment exercise windows."
---

# 11 questions to ask when negotiating a job offer including stock options

You just got a job offer - exciting! Now you're thinking about negotiating — also exciting. But your offer includes stock options... what now? .

It's easy to know what your salary target is based on factors like where you live and your seniority. But how do you evaluate the options being offered and negotiate a compensation package that's right for you? An offer of 100,000 options may sound significant, but the number alone doesn't tell you much as several factors determine their actual value.
...
### #1: What type of options are they?

There are two common forms of stock options that you might receive as part of a compensation package: incentive stock options (ISOs) and non-qualified stock options (NSOs). Restricted stock units (RSUs) are another type of equity, more commonly awarded by mature companies. Each type is taxed differently, so knowing what you're offered is crucial for understanding tax implications.
...
#### #3: When was the last fundraising round and what did it value the company at?

The company's value is shared among all equity holders. Its valuation represents the whole pie, and as a shareholder, you get a slice. You can also ask for the current preferred share price, though not every company discloses this figure to current or potential employees.

#### #4: What is the most recent 409A valuation and when was it calculated?

The 409A valuation (also known as fair market value) is an appraisal of the value of the company's common shares, calculated for tax purposes. Taxes on your equity compensation are based on the 409A valuation.
...
#### #5: What percentage ownership of the company do these options represent, and how are you calculating that number?
...
If you're comparing offers from multiple firms, it's helpful to think in terms of ownership stake. If Company A offers you 100 options out of 1 million shares, that's .01 percent ownership. If Company B offers 1,000 options out of 100 million shares, that's .001 percent ownership. So, the smaller quantity offered by Company A actually equals a larger ownership stake.

Your stake at the time of exit will probably not be the same as your stake when you join the firm. As your company creates new shares for new employees and investors, your stake slowly goes down. This is called dilution. While dilution reduces your stake, your overall gains can still rise if the company's valuation grows sufficiently.
...
#### #7: Is early exercise allowed?

Early exercising is when you exercise your stock options before they vest. This could increase your gains by minimizing your overall taxes and/or by decreasing the upfront costs when you exercise.
...
#### #9: What happens if I leave the company?
...
#### #10: Does the company offer tender programs on a regular basis?
...
#### #11: Do you offer any education about understanding my options and how to exercise?

Stock options are important for attracting and retaining employees, but making sure candidates and employees understand their stock options is equally valuable. Ask how the company educates its employees about understanding and managing their equity.

## Understanding the company and its business plan

Learning about the company's trajectory can provide insight into your stock options' future value. While the company may not disclose all details, asking about sales projections, hiring plans, future fundraising, and the company's exit strategy is advisable.

Additionally, inquire about what exit value must be met before common stock (which you'll own) holds positive value. This relates to liquidation preferences or "preference stack" which typically prioritize negotiated investor payouts before common shareholders receive anything in the event of an exit.

## Be clear about personal risk tolerance and cash needs
