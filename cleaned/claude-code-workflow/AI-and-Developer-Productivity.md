...
source_domain: "www.codemag.com"
word_count: 4021
text_to_link_ratio: 0.891
signal_score: 0.991
is_curated: false
tags:
  - open-source
...
![](https://epsenterprise.blob.core.windows.net/permanent-files/FileAttachments/d76871b4_9421_4b2d_aaa8_b73e4f7de5a1/2212051_Header_Large.jpeg) ![](https://epsenterprise.blob.core.windows.net/permanent-files/FileAttachments/52012d02_de11_4f5f_b743_8bbd85530840/2212051_Header_Wide.jpeg) ![](https://epsenterprise.blob.core.windows.net/permanent-files/FileAttachments/da732561_1c17_4168_8d0e_3cd880f61fde/2212051_Header_Small.jpeg)
Advertisement: 
# AI and Developer Productivity
![](https://www.codemag.com/Article/AuthorPhotoSmall/2429cb02-0fbc-46a4-afbc-af38e7159139)By **[Sahil Malik](https://www.codemag.com/People/Bio/Sahil.Malik)**  
Published in: **[CODE Magazine: 2025 - Sep/Oct](https://www.codemag.com/Magazine/Issue/58f52a45-4741-4d04-b88d-a0e80fe0b32c)**  
Last updated: December 26, 2025
[![CODE Magazine](https://www.codemag.com/images/Logos/DoodleFreeSubscriptionBanner.png)](https://www.codemag.com/subscribe/freearticle6b1?utm_source=articleviewer&utm_medium=banner&utm_campaign=Article-Viewer-Free-Subs)
Syntax Highlight Theme:  
Brown Paper Codepen Embed Color Brewer Dracula Dark Darkula Default Dracula Far Foundation Github Github Gist GoogleCode Grayscale Idea IR Black Kava Docs Kava Docs Dark Kimbie.Dark Kimbie.Light Magula Mono Blue Monokai Monokai Sublime Obsidian Paraiso Dark Paraiso Light Rails Casts Rainbow Solarized Dark Solarized Light Sunburst Twilight VS VS2015 XCode ZenBurn
## Published in:
[![](https://www.codemag.com/Magazine/CoverLarge/58f52a45-4741-4d04-b88d-a0e80fe0b32c)](https://www.codemag.com/Magazine/Issue/58f52a45-4741-4d04-b88d-a0e80fe0b32c)
## Filed under:
...
All right, enough talk. Let's see an example. I went ahead and installed Ollama and pulled down the Code Llama model. If this sounds Greek to you, please [see this article](https://www.codemag.com/Article/2411031/AI-with-No-Internet-Connection) where I talk about AI with no internet connection. I talk about how to use Ollama to create a local chatbot backed by a PDF. Although that article talked about an LLM indexing your content, you can use the same mechanism to work with code, except that you use a different model. There are many models to pick from, I picked Code Llama because it works well with code.
To allow the continue extension to talk my local model, I created a `config.yaml`, as can be seen in **Figure 1,** in my local profile in the `.continue` folder.
![Figure 1: The config.yaml for the continue extension](https://codemag.com/Article/Image/2509021/image1.png)  
**Figure 1:** The config.yaml for the continue extension
...
![Figure 2: The chat window for the continue extension](https://codemag.com/Article/Image/2509021/image2.png)  
**Figure 2:** The chat window for the continue extension
Now, you can work with any code base, but I'll just pick the code I showed in my AI with no internet connection article. Some of the concepts were a bit wiry, so I open the `index.py` from that code example, and, with my mouse, select an arbitrary portion of the code, as can be seen in **Figure 3**.
![Figure 3: Some code selected. This code seemed important.](https://codemag.com/Article/Image/2509021/image3.png)  
**Figure 3:** Some code selected. This code seemed important.
...
![Figure 4: My starting GitHub Copilot settings](https://codemag.com/Article/Image/2509021/image4.png)  
**Figure 4:** My starting GitHub Copilot settings
...
Create a nodejs application that serves REST APIs and creates a 
route at /hello that returns a JSON greeting.
...
![Figure 5: My application written up for me](https://codemag.com/Article/Image/2509021/image5.png)  
**Figure 5:** My application written up for me
All I have to do now is hit Continue to run **npm install**. Copilot then instructs me to run **npm start** , which I do, and visit `http://localhost:3000/hello`, and my application is running. This can be seen in **Figure 6**.
![Figure 6: My application is now running.](https://codemag.com/Article/Image/2509021/image6.png)  
**Figure 6:** My application is now running.
...
Now when I visit, `"http://localhost:3000/hello?name=sahil"` the output is:
...
![Figure 7: It even helps me with Git stuff.](https://codemag.com/Article/Image/2509021/image7.png)  
**Figure 7:** It even helps me with Git stuff.
This is so easy, it feels like cheating.
Reviewing the author's PR, I notice that the author has changed line 242 in `application.py`. Lazy person that I am, I select those lines, and ask Copilot to review it.
![Figure 8: Reviewing stuff and looking smarter than I really am](https://codemag.com/Article/Image/2509021/image8.png)  
**Figure 8:** Reviewing stuff and looking smarter than I really am
...
![Figure 9: Reviewing PRs the easy way](https://codemag.com/Article/Image/2509021/image9.png)  
**Figure 9:** Reviewing PRs the easy way
...
Back to the MSAL Python library, or feel free to pick any real codebase. I opened a particularly wiry part of the code, which is `broker.py`. I tried reading it, but it made my head hurt.
Advertisement
...
Please document this code for me with diagrams in a file called broker.md.

```

In a matter of seconds, a new `broker.md` file is created for me. You just have to take my word for it; this is about the best documentation I've seen, complete with diagrams. I've pasted a partial screenshot of the documentation in **Figure 10** for your review.
![Figure 10: Automated documentation rocks](https://codemag.com/Article/Image/2509021/image10.png)  
**Figure 10:** Automated documentation rocks
...
Failed to resolve import "./Ap.jsx" from "src/main.jsx". 
Does the file exist?
...
Please fix this bug "Failed to resolve import "./Ap.jsx" from
"src/main.jsx". Does the file exist?"

```

This sets Copilot thinking, and, in a matter of seconds, it fixes my error. The output of Copilot is shown in **Figure 11**.
![Figure 11: Automated bug fixing](https://codemag.com/Article/Image/2509021/image11.png)  
**Figure 11:** Automated bug fixing
And it even shows me in a diff format exactly the change it made in the file, as can be seen in **Figure 12**.
![Figure 12: My bug fixed by AI](https://codemag.com/Article/Image/2509021/image12.png)  
**Figure 12:** My bug fixed by AI
...
To save me time, I go to `gemini.google.com` and say `Please summarize <video url>`, and Gemini immediately gives me a nice little summary, with time stamps. This can be seen in **Figure 13**.
![Figure 13: A crisp summary of a long rambling video](https://codemag.com/Article/Image/2509021/image13.png)  
**Figure 13:** A crisp summary of a long rambling video
...
I went to `notebooklm.google.com` and created a new notebook and imported this video as source. Note that you can also import multiple sources. Now I can start interacting with that video by chatting with it. Let's give it a try.
...
![Figure 14: Learning is supercharged with AI.](https://codemag.com/Article/Image/2509021/image14.png)  
**Figure 14:** Learning is supercharged with AI.
...
![Figure 15: Git mind map](https://codemag.com/Article/Image/2509021/image15.png)  
**Figure 15:** Git mind map
...
"How do I rebase when I do a Git pull automatically?"
...
![Figure 16: Pretty good help on rebasing with Git](https://codemag.com/Article/Image/2509021/image16.png)  
**Figure 16:** Pretty good help on rebasing with Git
## Summary
...
[![](https://www.codemag.com/Magazine/CoverLarge/58f52a45-4741-4d04-b88d-a0e80fe0b32c)](https://www.codemag.com/Magazine/Issue/58f52a45-4741-4d04-b88d-a0e80fe0b32c)
[![](https://www.codemag.com/Images/Banners/Red%20End%20of%20Article%20Banner%20v2.png)](https://www.codemag.com/subscribe/freearticle6b1?utm_source=articleviewer&utm_medium=end_banner_d&utm_campaign=Article-Viewer-Free-Subs)
#### Have additional technical questions?
Get help from the experts at _CODE Magazine_ - sign up for our free hour of consulting!
