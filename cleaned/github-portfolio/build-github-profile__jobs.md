...
source_domain: "www.boot.dev"
word_count: 1373
text_to_link_ratio: 0.6138
signal_score: 0.7138
is_curated: false
tags:
  - open-source
...
Categories 
[All ](https://www.boot.dev/blog/)[News ](https://www.boot.dev/blog/news/)[DevOps ](https://www.boot.dev/blog/devops/)[Python ](https://www.boot.dev/blog/python/)[Backend ](https://www.boot.dev/blog/backend/)[Education ](https://www.boot.dev/blog/education/)[Jobs ](https://www.boot.dev/blog/jobs/)[Computer Science ](https://www.boot.dev/blog/computer-science/)[Golang ](https://www.boot.dev/blog/golang/)[Vue ](https://www.boot.dev/blog/vue/)[JavaScript ](https://www.boot.dev/blog/javascript/)[Security ](https://www.boot.dev/blog/security/)[Rust](https://www.boot.dev/blog/rust/)
# How to Build the Best GitHub Profile for Your Job Search
[Boot.dev Blog](https://www.boot.dev/blog/) » [Jobs](https://www.boot.dev/blog/jobs/) » How to Build the Best GitHub Profile for Your Job Search
[![Lane Wagner](https://www.boot.dev/blog/img/800/lane-profile.webp)](https://www.boot.dev/teachers/lane-wagner/)
...
## [Pin and order your best repositories](https://www.boot.dev/blog/jobs/build-github-profile/#pin-and-order-your-best-repositories)
...
## [Give yourself a profile picture, username and bio](https://www.boot.dev/blog/jobs/build-github-profile/#give-yourself-a-profile-picture-username-and-bio)
...
## [Create an amazing Readme for each of the projects you have pinned](https://www.boot.dev/blog/jobs/build-github-profile/#create-an-amazing-readme-for-each-of-the-projects-you-have-pinned)
...
## [Add a profile Readme](https://www.boot.dev/blog/jobs/build-github-profile/#add-a-profile-readme)
...
## [If your heatmap is bare, you should be coding more](https://www.boot.dev/blog/jobs/build-github-profile/#if-your-heatmap-is-bare-you-should-be-coding-more)
...
![github heatmap](https://www.boot.dev/blog/img/800/github_heatmap.webp)
## [Make your embarrassing repositories private](https://www.boot.dev/blog/jobs/build-github-profile/#make-your-embarrassing-repositories-private)
...
## [Work on a mix of applications, libraries, and open source contributions](https://www.boot.dev/blog/jobs/build-github-profile/#work-on-a-mix-of-applications-libraries-and-open-source-contributions)
...
## [Try to get some stars](https://www.boot.dev/blog/jobs/build-github-profile/#try-to-get-some-stars)
...
## [Dedicate some time to optimizing your GitHub](https://www.boot.dev/blog/jobs/build-github-profile/#dedicate-some-time-to-optimizing-your-github)
...
### Related Articles
  * ## [Coding Interviews - Why you shouldn't give homework Nov 18, 2021 by Lane Wagner - Boot.dev co-founder and backend engineer A while back I went through the interview process at a company I won’t name here. The first interview was basically just a phone screen, where I was able to chat with my would-be manager about things like compensation range, tech stack, work duties, etc. It went well! The guy was delightful. ](https://www.boot.dev/blog/jobs/coding-interviews-why-you-shouldnt-give-homework/)
  * ## [Which is Worth It, Coding Bootcamp or a Computer Science Degree? Mar 29, 2021 by Zulie Rane - Data analysis and computer science techincal author When you’re in a position of wondering, “Is a coding bootcamp worth it?” you should look at several factors. Coding bootcamp costs, on average, around $13,000. This holds true no matter if you choose to attend coding bootcamp in person or online, though there’s a lot of variance in how much coding bootcamp costs, ranging from $3,000 to $20,000 depending on the language, the length, and who’s running it. ](https://www.boot.dev/blog/jobs/is-coding-bootcamp-worth-it/)
  * ## [Can You Get a Programming Job with Just an Associate's Degree? Mar 22, 2021 by Lane Wagner - Boot.dev co-founder and backend engineer Changing majors is a tale as old as time. A degree that would normally require four years to complete can quickly turn into a more expensive endeavor that takes five or six years for a student that can’t decide what they want to study. The interesting thing about programming jobs is that they don’t require a degree at all, but if you at least complete an associate’s degree, you’ll have a better chance of landing that first job. ](https://www.boot.dev/blog/jobs/programming-job-with-associates-degree/)
  * ## [Where Can You Get a Programming Certificate Online? Mar 14, 2021 by Zulie Rane - Data analysis and computer science techincal author There are two main options to get a programming certificate online - online courses and universities. There are two ways to get a programming certificate online - universities and online courses. In the simplest possible terms, a programming certificate is something that lets you walk up to an employer and say, “Hello, yes, I know how to SQL. Here’s a piece of paper that proves it. You should hire me.” ](https://www.boot.dev/blog/jobs/where-to-get-a-programming-certificate/)
