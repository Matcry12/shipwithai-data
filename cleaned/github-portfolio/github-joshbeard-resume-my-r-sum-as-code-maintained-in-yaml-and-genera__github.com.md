---
title: "GitHub - joshbeard/resume: 💼 My résumé as code. Maintained in YAML and generated in several formats"
...
doc_type: "reference"
core_question: "What qualifies someone as a platform engineer and infrastructure leader?"
tldr: "Platform engineer and manager with 15+ years building CI/CD infrastructure, DevOps tooling, and platform strategy enabling teams to ship faster."
---

# GitHub - joshbeard/resume: 💼 My résumé as code. Maintained in YAML and generated in several formats

- Email: josh@joshbeard.com
- Web: joshbeard.com
- GitHub: github.com/joshbeard
...
*Previously: Staff DevOps Engineer (February 2025 - February 2026), Senior DevOps Engineer (September 2022 - February 2025)*
...
*Key technology and skills:AWS, CI/CD, DataDog, Devcontainers, Docker, GitLab, GitOps, Go, Golang, Kubernetes, GitHub Actions, Platform Engineering, Python, Shell, Terraform, Traefik*
...
*Key technology and skills:AWS, CloudFormation, GitLab, Python*

*Previously: Senior DevOps Engineer (September 2015 - December 2019)*
...
*Key technology and skills:AWS, CI/CD, GitLab, Docker, Terraform, Ansible, Platform Engineering, GitOps, Puppet, Python, Nginx, Traefik*
...
*Key technology and skills:Puppet, Linux, Ruby, Git, Shell*
...
*Key technology and skills:Linux, Unix, Puppet, Nginx, MySQL, KVM, PHP*
...
- man page:
- Linux/GNU:
`man <(curl -sl https://joshbeard.com/resume/joshbeard-resume.7)`

- macOS/BSD:
`curl -sL https://joshbeard.com/resume/joshbeard-resume.7 > /tmp/joshbeard.7 && man /tmp/joshbeard.7`

- Linux/GNU:

*This README was generated from the resume.yaml file and using gomplate and the resume.md.tmpl template.*
