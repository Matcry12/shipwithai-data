---
title: "Github on Resume"
topic: "github-portfolio"
career_level:
  - entry
  - senior
  - executive
source_url: "https://www.visualcv.com/github-on-resume"
source_domain: "www.visualcv.com"
word_count: 2925
text_to_link_ratio: 0.9073
signal_score: 0.9073
is_curated: false
tags:
  - open-source
...
### Example 1: Technical Skills Section
  * Languages & Tools: Python, JavaScript (React/Node), GitHub, Docker, AWS
  * Github Profile: [github.com/yourusername](http://github.com/yourusername)
...
### Example 2: Project Experience or Work Samples Section
  ...
  * Link to Repository: [github.com/yourusername/projectname](http://github.com/yourusername/projectname)
...
Listing individual code snippets on a resume can be an effective way to showcase your programming skills and demonstrate your proficiency in specific languages or technologies. Here are some best practices to follow when listing this subcategory:
  ...
  * **Use GitHub Links** : Include a link to your GitHub profile or specific repositories where relevant code snippets are hosted. This allows potential employers to easily access your work, review the code, and understand the scope of your projects.
    * Project Name: Weather API Language: Python, Flask Description: A simple web API that retrieves weather data using OpenWeatherMap's API. [GitHub Repository](https://github.com/YourUsername/WeatherAPI)
...
In this example, a candidate is applying for a software engineering role at a company specializing in data analysis and machine learning. They have created several projects using Python, R, and other relevant languages and tools, which they list on their resume with links to their GitHub repositories:
  * **Data Analysis Projects**
    * Stock Price Prediction (Python) [GitHub](https://github.com/YourUsername/StockPrediction)
    * Churn Analysis for Telecom Company (R) [GitHub](https://github.com/YourUsername/ChurnAnalysis)
    * Social Media Sentiment Analysis (Python, NLTK) [GitHub](https://github.com/YourUsername/SentimentAnalysis)
...
In this example, a candidate is applying for a full-stack developer position and has several projects showcasing their frontend and backend skills. They list their repositories on GitHub as well as a brief description of each project to highlight their expertise:
  * **Frontend Projects**
    * E-commerce Website (React, Redux) [GitHub](https://github.com/YourUsername/EcommerceWebsite)
    * Personal Blog (Next.js, GraphQL) [GitHub](https://github.com/YourUsername/PersonalBlog)
  * **Backend Projects**
    * RESTful API for Event Management (Node.js, Express) [GitHub](https://github.com/YourUsername/EventManagementAPI)
    * Weather API (Python, Flask) [GitHub](https://github.com/YourUsername/WeatherAPI)
...
### Best Practices for Listing 'Collaborative Repositories' in Github context:
  ...
  * Example: [GitHub Profile](https://github.com/YourUsername) - Contains collaborative projects on various technologies like JavaScript, ReactJS, NodeJS, and more.
...
Include a hyperlink to your GitHub profile at the top or bottom of your resume, making it easy for recruiters to access your contributions directly.
  * Check out my open source projects and contributions on [GitHub](https://github.com/YourUsername)!
...
Description: A web-based application that displays real-time weather data for any location. Built using React, Redux, and the OpenWeatherMap API. [GitHub Repository](https://github.com/yourusername/weather-app)
...
## Projects on Github (Team Project)
  * Real-Time Data Visualization Tool Description: A web application that displays real-time data from various sources, such as social media or financial markets. Built using D3.js and Node.js. [GitHub Repository](https://github.com/yourusername/datavis) Contributions: Collaborated with a team of three developers to implement the frontend using D3.js. Also contributed to backend development using Node.js and Express.
...
[English](https://www.visualcv.com/github-on-resume/)[Deutsch](https://www.visualcv.com/de/)[Français](https://www.visualcv.com/fr/)[中文](https://www.visualcv.com/zh/)[Pусский](https://www.visualcv.com/ru/)[Português](https://www.visualcv.com/pt/)[Español](https://www.visualcv.com/es/)[لعربية](https://www.visualcv.com/ar/)[Türkçe](https://www.visualcv.com/tr/)
![](https://bat.bing.com/action/0?ti=17355304&tm=gtm002&Ver=2&mid=5d5c6bb6-6fc3-494f-815f-88b9bc546402&bo=1&sid=badd5b4047e111f195cc0bc354686628&vid=badd5a4047e111f1a49bb76d9be4dcd3&vids=1&msclkid=N&uach=pv%3D10.0&pi=2083220816&lg=en-US&sw=1080&sh=600&sc=24&tl=Github%20On%20Resume%3A%20How%20To%20List%20Projects,%20Open%20Source%20Contributions,%20...&p=https%3A%2F%2Fwww.visualcv.com%2Fgithub-on-resume%2F&r=&lt=148&evt=pageLoad&sv=2&cdb=AQAQ&rn=766822)
