---
title: "Staff, principal, distinguished: Engineering career levels explained"
...
career_level:
  ...
  - senior
  - executive
source_url: "https://shiftmag.dev/staff-principal-distinguished-engineering-career-levels-explained-3565"
source_domain: "shiftmag.dev"
word_count: 1053
text_to_link_ratio: 0.9093
signal_score: 1.0
is_curated: false
tags:
  - open-source
...
![](https://shiftmag.dev/wp-content/uploads/2024/06/Formatting-messages.png?x91379)
...
![](https://shiftmag.dev/wp-content/uploads/2024/06/we-are-developers-1-1024x538.png?x91379)
# Principal Engineer
...
Also, sometimes,**there is one more step before the top.** If you are a principal engineer at Infobip, your next step is to become a **senior principal engineer**. This is how Infobip defined the role in its [Engineering Handbook](https://infobipengineering.gitbook.io/handbook/career-development/career-development):
> _We expect you to be an authority in engineering within the company-wide scope and work to ensure long-term stability, security, and performance within the scope of whole Infobip platform. You are able to visualize and share the current Infobip architecture and infrastructure (HW, SW, cloud, database, network…) and drive research areas upon new initiatives and technologies._   
>   
> _You are always ready to provide technical consultancy to rest of Engineering department and you are a member of something that we call A-team._
...
_**Want to know how to reach this level? Get insights from Foursquare’s engineering leader:[How to Become a Distinguished Engineer: Lessons from Foursquare](https://shiftmag.dev/how-to-become-distinguished-engineer-1717/)**_
# Why is it essential to have a well-defined hierarchy?
Software engineers’ different titles and levels define specific experience levels, tasks, and responsibilities. Companies may use some or all of these levels, **but having a hierarchy is essential for clarity and motivation.** To see a concrete example, check the [Infobips Engineering Handbook to learn how Infobip has defined an engineer’s career development.](https://infobipengineering.gitbook.io/handbook/career-development/career-development)
...
Microsoft doesn't publish its engineering ladder. I dug through leaks, salary data, and career pages so you don't have to. Here's the full picture.
Decoding the AWS system is a roadmap for developers aiming for the top tiers of Big Tech. Here’s how to climb the ladder.
