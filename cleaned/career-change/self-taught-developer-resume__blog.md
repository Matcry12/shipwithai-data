---
title: "Self-Taught Developer Resume: Positioning Projects as Your Main Experience"
topic: "career-change"
career_level:
  - senior
...
**Bad:**  
_"General Assembly — Web Development Bootcamp, 2025"_
**Good:**  
_"General Assembly — Software Engineering Immersive (480 hours), 2025. Full-stack development program covering JavaScript, React, Python, Django, and PostgreSQL. Capstone: Built a real-time collaborative code editor with WebRTC."_
...
## What to Skip
Here is what _not_ to put on your self-taught developer resume:
...
Before you send your resume out, run it through a [resume checker](https://quickcv.io/resume-checker) to make sure the formatting is clean and the keywords match the roles you are targeting. ATS systems can be particularly tricky with non-traditional resume structures, so it is worth double-checking that yours parses correctly.
...
## Related Articles
[Career Transition Military to Civilian Resume Translation Guide Translate military jargon into corporate language that hiring managers understand. A step-by-step guide for veterans entering the civilian job market. Read article →](https://quickcv.io/blog/military-to-civilian-resume)[Career Transition From Retail to Office: Resume Guide for Industry Switchers Ready to leave the shop floor? Here's how to rewrite your retail experience for office roles—with specific examples of how to translate your skills. Read article →](https://quickcv.io/blog/retail-to-office-resume)[Career Transition How to Write a Career Change Resume That Gets Noticed Pivoting to a new industry? Learn how to restructure your resume to highlight potential and passion over direct experience. Read article →](https://quickcv.io/blog/career-change-resume-guide)
