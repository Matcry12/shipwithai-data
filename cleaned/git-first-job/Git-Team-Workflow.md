---
title: "[Git-Team-Workflow](https://make-school-courses.github.io/Git-Team-Workflow/)"
topic: "git-first-job"
career_level:
  - executive
...
## Overview[](https://make-school-courses.github.io/Git-Team-Workflow/#overview)
The team workflow presented here is based on Vincent Driessen’s article [“A successful Git branching model”](http://nvie.com/posts/a-successful-git-branching-model/) that introduced the “Git flow” pattern, which is now a best practice used by software engineering teams around the world.
...
![Diagram 1: Complete workflow](https://make-school-courses.github.io/Git-Team-Workflow/images/1-complete-workflow.png)
## Getting Started[](https://make-school-courses.github.io/Git-Team-Workflow/#getting-started)
...
## Instructions[](https://make-school-courses.github.io/Git-Team-Workflow/#instructions)
...
While working on a team, you will create branches to manage team workflow:
  * You need to have an always working published **Production** version. This is usually the `master` branch.
  * Your team will be continually iterating on the **Development** version. This is usually the `develop` branch.
  * Team members will also be developing several **New Features** in parallel that may sometimes take a while to complete before they are ready to be incorporated into the Development version. These are called `feature` branches.
  * Movie executives (users) may find typos (bugs) in the Production version at any time, so you need to be able to fix and publish (push) **Hot Fixes** quickly without introducing recent changes from the Development version that are not ready to be published (tested for Production). These are called `hot-fix` or `bug-fix` branches.
...
### Rename Character[](https://make-school-courses.github.io/Git-Team-Workflow/#rename-character)
...
![Diagram 2: Rename character](https://make-school-courses.github.io/Git-Team-Workflow/images/2-rename-character.png)
### Oh No… Typos![](https://make-school-courses.github.io/Git-Team-Workflow/#oh-no-typos)
...
![Diagram 3: Typo fixes](https://make-school-courses.github.io/Git-Team-Workflow/images/3-typo-fixes.png)
These new changes should be incorporated into the Development version.
  * `git checkout develop`
  * `git merge typo-fixes`


![Diagram 4: Merge typo fixes](https://make-school-courses.github.io/Git-Team-Workflow/images/4-merge-typo-fixes.png)
### Add New Characters[](https://make-school-courses.github.io/Git-Team-Workflow/#add-new-characters)
...
![Diagram 5: New character](https://make-school-courses.github.io/Git-Team-Workflow/images/5-new-character.png)
### Improve Story Ending[](https://make-school-courses.github.io/Git-Team-Workflow/#improve-story-ending)
...
![Diagram 6: New story ending](https://make-school-courses.github.io/Git-Team-Workflow/images/6-new-story-ending.png)
### Merge new character branch into develop[](https://make-school-courses.github.io/Git-Team-Workflow/#merge-new-character-branch-into-develop)
...
![Diagram 7: Merge new character](https://make-school-courses.github.io/Git-Team-Workflow/images/7-merge-new-character.png)
### Review new script and ship it![](https://make-school-courses.github.io/Git-Team-Workflow/#review-new-script-and-ship-it)
...
![Diagram 8: Complete workflow](https://make-school-courses.github.io/Git-Team-Workflow/images/1-complete-workflow.png)
...
In the course of a team project you are likely to apply the steps outlined here several times. You should follow this process on real team projects. Over time, this will make your team more productive while working in parallel.
## Additional Resources[](https://make-school-courses.github.io/Git-Team-Workflow/#additional-resources)
