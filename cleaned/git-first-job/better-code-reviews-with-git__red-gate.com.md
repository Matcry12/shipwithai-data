...
tldr: "Techniques for effective Git-based code reviews using pull requests including in-code comments, commit messages, PR preambles, and pre-review communication."
---
