...
topic: "git-first-job"
career_level: []
source_url: "https://intersect-training.org/collaborative-git/git-workflows"
source_domain: "intersect-training.org"
word_count: 1997
text_to_link_ratio: 0.9585
signal_score: 1.0
is_curated: false
tags:
  - remote
...
Collaborative Git 
# Git Workflows
Last updated on 2025-06-16 | [Edit this page ](https://github.com/INTERSECT-training/collaborative-git/edit/main/episodes/git-workflows.md)
...
## Introduction[](https://intersect-training.org/collaborative-git/git-workflows.html#introduction)
* * *
...
## Some Common Workflows[](https://intersect-training.org/collaborative-git/git-workflows.html#some-common-workflows)
* * *
...
### Centralized or Truck-Based Workflow[](https://intersect-training.org/collaborative-git/git-workflows.html#centralized-or-truck-based-workflow)
...
### Feature Branching Workflows and GitHub Flow[](https://intersect-training.org/collaborative-git/git-workflows.html#feature-branching-workflows-and-github-flow)
...
### Git Flow[](https://intersect-training.org/collaborative-git/git-workflows.html#git-flow)
...
### GitLab Flow[](https://intersect-training.org/collaborative-git/git-workflows.html#gitlab-flow)
...
### Forking Workflows[](https://intersect-training.org/collaborative-git/git-workflows.html#forking-workflows)
...
## Communicating with your Collaborators[](https://intersect-training.org/collaborative-git/git-workflows.html#communicating-with-your-collaborators)
* * *
...
## Enforcing your Workflow[](https://intersect-training.org/collaborative-git/git-workflows.html#enforcing-your-workflow)
* * *
...
## Activity[](https://intersect-training.org/collaborative-git/git-workflows.html#activity)
* * *
...
## Additional Resources[](https://intersect-training.org/collaborative-git/git-workflows.html#additional-resources)
* * *
...
[   
Back To Top ](https://intersect-training.org/collaborative-git/git-workflows.html#top)
