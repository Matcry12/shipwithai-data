...
## Getting your merge request reviewed, approved, and merged[](https://docs.gitlab.com/development/code_review/#getting-your-merge-request-reviewed-approved-and-merged "Permalink")
Before you begin:
  * Familiarize yourself with the [contribution acceptance criteria](https://docs.gitlab.com/development/contributing/merge_request_workflow/#contribution-acceptance-criteria).
...
As soon as you have code to review, have the code **reviewed** by a [reviewer](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#reviewer). This reviewer can be from your group or team, or a [domain expert](https://docs.gitlab.com/development/code_review/#domain-experts). The reviewer can:
...
Otherwise, a merge request should be first reviewed by a reviewer in each [category (for example: backend, database)](https://docs.gitlab.com/development/code_review/#approval-guidelines) the MR touches, as maintainers may not have the relevant domain knowledge. This also helps to spread the workload.
For assistance with security scans or comments, include the Application Security Team (`@gitlab-com/gl-security/appsec`).
The reviewers use the [reviewer functionality](https://docs.gitlab.com/user/project/merge_requests/reviews/) in the sidebar. Reviewers can add their approval by [approving additionally](https://docs.gitlab.com/user/project/merge_requests/approvals/#approve-a-merge-request).
Depending on the areas your merge request touches, it must be **approved** by one or more [maintainers](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#maintainer). The **Approved** button is in the merge request widget.
...
Read more about [author responsibilities](https://docs.gitlab.com/development/code_review/#the-responsibility-of-the-merge-request-author) below.
### Domain experts[](https://docs.gitlab.com/development/code_review/#domain-experts "Permalink")
...
We default to assigning reviews to team members with domain expertise for code reviews. UX reviews default to the recommended reviewer from the Review Roulette. Due to designer capacity limits, areas not supported by a Product Designer will no longer require a UX review unless it is a community contribution. When a suitable [domain expert](https://docs.gitlab.com/development/code_review/#domain-experts) isn’t available, you can choose any team member to review the MR, or follow the [Reviewer roulette](https://docs.gitlab.com/development/code_review/#reviewer-roulette) recommendation (see above for UX reviews). Double check if the person is OOO before assigning them.
...
### Reviewer roulette[](https://docs.gitlab.com/development/code_review/#reviewer-roulette "Permalink")
...
The [Danger bot](https://docs.gitlab.com/development/dangerbot/) randomly picks a reviewer and a maintainer for each area of the codebase that your merge request seems to touch. It makes **recommendations** for developer reviewers and you should override it if you think someone else is a better fit.
[Approval Guidelines](https://docs.gitlab.com/development/code_review/#approval-guidelines) can help to pick [domain experts](https://docs.gitlab.com/development/code_review/#domain-experts).
...
It picks reviewers and maintainers from the list at the [engineering projects](https://handbook.gitlab.com/handbook/engineering/projects/) page, with these behaviors:
  * It doesn’t pick people whose Slack or [GitLab status](https://docs.gitlab.com/user/profile/#set-your-status):
...
Review requests for merge requests that do not target the default branch of any project under the [security group](https://gitlab.com/gitlab-org/security/) are not counted. These MRs are usually backports, and maintainers or reviewers usually do not need much time reviewing them.
  ...
  * People whose Slack or [GitLab status](https://docs.gitlab.com/user/profile/#set-your-status) emoji is Ⓜ `:m:`are only suggested as reviewers on projects they are a maintainer of.
...
### Approval guidelines[](https://docs.gitlab.com/development/code_review/#approval-guidelines "Permalink")
As described in the section on the responsibility of the maintainer below, you are recommended to get your merge request approved and merged by maintainers with [domain expertise](https://docs.gitlab.com/development/code_review/#domain-experts). The optional approval of the first reviewer is not covered here. However, your merge request should be reviewed by a reviewer before passing it to a maintainer as described in the [overview](https://docs.gitlab.com/development/code_review/#getting-your-merge-request-reviewed-approved-and-merged) section.  
...
|  `~database` migrations or changes to expensive queries 2  |  [Database maintainer](https://handbook.gitlab.com/handbook/engineering/projects/#gitlab_maintainers_database). Refer to the [database review guidelines](https://docs.gitlab.com/development/database_review/) for more details.  |  
...
#### CODEOWNERS approval[](https://docs.gitlab.com/development/code_review/#codeowners-approval "Permalink")
...
When adding a mandatory section, you should track the impact on the new mandatory section on merge request rates. See the [Verify issue](https://gitlab.com/gitlab-org/gitlab/-/issues/411559) for a good example.
...
#### Acceptance checklist[](https://docs.gitlab.com/development/code_review/#acceptance-checklist "Permalink")
...
##### Quality[](https://docs.gitlab.com/development/code_review/#quality "Permalink")
For further quality guidelines, see [testing](https://handbook.gitlab.com/handbook/engineering/testing/).
  1. You have self-reviewed this MR per [code review guidelines](https://docs.gitlab.com/development/code_review/).
...
##### Performance, reliability, and availability[](https://docs.gitlab.com/development/code_review/#performance-reliability-and-availability "Permalink")
  ...
  2. You have added [information for database reviewers in the MR description](https://docs.gitlab.com/development/database_review/#required), or you have decided that it is unnecessary.
...
##### Observability instrumentation[](https://docs.gitlab.com/development/code_review/#observability-instrumentation "Permalink")
...
##### Documentation[](https://docs.gitlab.com/development/code_review/#documentation "Permalink")
...
##### Security[](https://docs.gitlab.com/development/code_review/#security "Permalink")
...
##### Deployment[](https://docs.gitlab.com/development/code_review/#deployment "Permalink")
  ...
  3. You have informed the Infrastructure department of a default setting or new setting change per [definition of done](https://docs.gitlab.com/development/contributing/merge_request_workflow/#definition-of-done), or decided that this is unnecessary.


##### Compliance[](https://docs.gitlab.com/development/code_review/#compliance "Permalink")
  1. You have confirmed that the correct [MR type label](https://docs.gitlab.com/development/labels/) has been applied.


### The responsibility of the merge request author[](https://docs.gitlab.com/development/code_review/#the-responsibility-of-the-merge-request-author "Permalink")
The responsibility to find the best solution and implement it lies with the merge request author. The author or [directly responsible individual](https://handbook.gitlab.com/handbook/people-group/directly-responsible-individuals/) (DRI) stays assigned to the merge request as the assignee throughout the code review lifecycle. If you are unable to set yourself as an assignee, ask a [reviewer](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#reviewer) to do this for you.
...
The best way to do this, and to avoid unnecessary back-and-forth with reviewers, is to perform a self-review of your own merge request, following the [Code Review](https://docs.gitlab.com/development/code_review/#reviewing-a-merge-request) guidelines. During this self-review, try to include comments in the MR on lines where decisions or trade-offs were made, or where a contextual explanation might aid the reviewer in more easily understanding the code.
...
They are encouraged to reach out to [domain experts](https://docs.gitlab.com/development/code_review/#domain-experts) to discuss different solutions or get an implementation reviewed, to product managers and UX designers to clear up confusion or verify that the end result matches what they had in mind, to database specialists to get input on the data model or specific queries, or to any other developer to get an in-depth review of the solution.
...
If an author is unsure if a merge request needs a [domain expert’s](https://docs.gitlab.com/development/code_review/#domain-experts) opinion, then that indicates it does. Without it, it’s unlikely they have the required level of confidence in their solution.
...
When assigning reviewers, it can be helpful to:
  * Add a comment to the MR indicating which _type_ of review you are looking for from that reviewer.
  ...
  * Only add TODO comments (referenced above) directly to the source code if the reviewer requires you to do so. If TODO comments are added due to an actionable task, [include a link to the relevant issue](https://docs.gitlab.com/development/code_comments/).
...
### The responsibility of the reviewer[](https://docs.gitlab.com/development/code_review/#the-responsibility-of-the-reviewer "Permalink")
...
If you are unavailable to review an assigned merge request within the [Review-response SLO](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#review-response-slo):
  ...
  2. Use the [GitLab Review Workload Dashboard](https://gitlab-org.gitlab.io/gitlab-roulette/) to select a new reviewer.
...
[Review the merge request](https://docs.gitlab.com/development/code_review/#reviewing-a-merge-request) thoroughly.
Verify that the merge request meets all [contribution acceptance criteria](https://docs.gitlab.com/development/contributing/merge_request_workflow/#contribution-acceptance-criteria).
...
When you are confident that it meets all requirements, you should:
  ...
  * Request a review from a maintainer. Default to requests for a maintainer with [domain expertise](https://docs.gitlab.com/development/code_review/#domain-experts), however, if one isn’t available or you think the merge request doesn’t need a review by a [domain expert](https://docs.gitlab.com/development/code_review/#domain-experts), feel free to follow the [Reviewer roulette](https://docs.gitlab.com/development/code_review/#reviewer-roulette) suggestion.


### The responsibility of the maintainer[](https://docs.gitlab.com/development/code_review/#the-responsibility-of-the-maintainer "Permalink")
...
Maintainers are the DRI of assuring that the acceptance criteria of a merge request are reasonably met. In general, [quality is everyone’s responsibility](https://handbook.gitlab.com/handbook/engineering/quality/), but maintainers of an MR are held responsible for **ensuring** that an MR meets those general quality standards.
This includes [avoiding the creation of technical debt in follow-up issues](https://docs.gitlab.com/development/contributing/issue_workflow/#technical-debt-in-follow-up-issues).
If a maintainer feels that an MR is substantial enough, or requires a [domain expert](https://docs.gitlab.com/development/code_review/#domain-experts), maintainers have the discretion to request a review from another reviewer, or maintainer. Here are some examples of maintainers proactively doing this during review:
...
### Dogfooding the Reviewers feature[](https://docs.gitlab.com/development/code_review/#dogfooding-the-reviewers-feature "Permalink")
Our code review process dogfoods the [Merge request reviews feature](https://docs.gitlab.com/user/project/merge_requests/reviews/). Here is a summary, which is also reflected in other sections.
  * Merge request authors and DRIs stay as Assignees.
  * Merge request reviewers stay as Reviewers even after they have reviewed.
  * Authors [request a review](https://docs.gitlab.com/user/project/merge_requests/reviews/#request-a-review) by assigning users as Reviewers.
  * Authors [re-request a review](https://docs.gitlab.com/user/project/merge_requests/reviews/#re-request-a-review) when they have made changes and wish a reviewer to re-review.
  * Reviewers use the [reviews feature](https://docs.gitlab.com/user/project/merge_requests/reviews/#start-a-review) to submit feedback. You can select **Start review** or **Start a review** rather than **Add comment now** in any comment context on the MR.


## Best practices[](https://docs.gitlab.com/development/code_review/#best-practices "Permalink")
### Everyone[](https://docs.gitlab.com/development/code_review/#everyone "Permalink")
  * Be kind.
...
### Recommendations for MR authors to get their changes merged faster[](https://docs.gitlab.com/development/code_review/#recommendations-for-mr-authors-to-get-their-changes-merged-faster "Permalink")
  1. Make sure to follow best practices.
     ...
     * Follow the [acceptance checklist](https://docs.gitlab.com/development/code_review/#acceptance-checklist).
  ...
  3. Consider splitting big MRs into smaller ones. Around `200` lines is a good goal.
     ...
     * Smaller MRs are often simpler, and you can consider skipping the first review and [sending directly to the maintainer](https://docs.gitlab.com/development/code_review/#getting-your-merge-request-reviewed-approved-and-merged), or skipping one of the suggested competency areas (frontend or backend, for example).
     * Mocks can be a good approach, even though they add another MR later; replacing a mock with a server request is usually a quick MR to review.
       * Be sure that any UI with mocked data is behind a [feature flag](https://docs.gitlab.com/development/feature_flags/).
     * Pull common dependencies into the first MRs to avoid excessive rebases.
       * For sequential MRs use [stacked diffs](https://docs.gitlab.com/user/project/merge_requests/stacked_diffs/).
  ...
  6. **Assign a maintainer who is a domain expert.**
  ...
  7. **Structure and write your MRs in a way that they are easy to review.**
...
### Having your merge request reviewed[](https://docs.gitlab.com/development/code_review/#having-your-merge-request-reviewed "Permalink")
...
### Responding to GitLab Duo review comments[](https://docs.gitlab.com/development/code_review/#responding-to-gitlab-duo-review-comments "Permalink")
...
### Requesting a review[](https://docs.gitlab.com/development/code_review/#requesting-a-review "Permalink")
When you are ready to have your merge request reviewed, you should [request an initial review](https://docs.gitlab.com/user/project/merge_requests/reviews/) by selecting a reviewer based on the [approval guidelines](https://docs.gitlab.com/development/code_review/#approval-guidelines).
...
When re-requesting a review, click the [**Re-request a review** icon](https://docs.gitlab.com/user/project/merge_requests/reviews/#re-request-a-review) ( redo ) next to the reviewer’s name, or use the `/request_review @user` quick action. This ensures the merge request appears in the reviewer’s **Reviews requested** section of their merge request homepage.
...
Sometimes, a maintainer may not be available for review. They could be out of the office or [at capacity](https://handbook.gitlab.com/handbook/engineering/workflow/code-review/#review-response-slo). You can and should check the maintainer’s availability in their profile. If the maintainer recommended by the roulette is not available, choose someone else from that list.
...
### Volunteering to review[](https://docs.gitlab.com/development/code_review/#volunteering-to-review "Permalink")
...
### Reviewing a merge request[](https://docs.gitlab.com/development/code_review/#reviewing-a-merge-request "Permalink")
...
### Merging a merge request[](https://docs.gitlab.com/development/code_review/#merging-a-merge-request "Permalink")
Before taking the decision to merge:
  * Set the milestone.
  * Confirm that the correct [MR type label](https://docs.gitlab.com/development/labels/#type-labels) is applied.
...
Some actions, such as rebasing locally or applying suggestions, are considered the same as adding a commit and could reset existing approvals. Approvals are not removed when rebasing from the UI or with the [`/rebase` quick action](https://docs.gitlab.com/user/project/quick_actions/#rebase).
When ready to merge:
**If the merge request is from a fork, also check the[additional guidelines for community contributions](https://docs.gitlab.com/development/code_review/#community-contributions).**
  * Consider using the [Squash and merge](https://docs.gitlab.com/user/project/merge_requests/squash_and_merge/) feature when the merge request has a lot of commits. When merging code, a maintainer should only use the squash feature if the author has already set this option, or if the merge request clearly contains a messy commit history, it will be more efficient to squash commits instead of circling back with the author about that. Otherwise, if the MR only has a few commits, we’ll be respecting the author’s setting by not squashing them.
  * Go to the merge request’s **Pipelines** tab, and select **Run pipeline**. Then, on the **Overview** tab, enable **Auto-merge**. Consider the following information:
    * If **[the default branch is broken](https://handbook.gitlab.com/handbook/engineering/workflow/#broken-master), do not merge the merge request** except for [very specific cases](https://handbook.gitlab.com/handbook/engineering/workflow/#criteria-for-merging-during-broken-master). For other cases, follow these [handbook instructions](https://handbook.gitlab.com/handbook/engineering/workflow/#merging-during-broken-master).
    ...
    * If the **latest[merged results pipeline](https://docs.gitlab.com/ci/pipelines/merged_results_pipelines/)** was **created less than 16 hours ago (72 hours for stable branches)** , you may merge without starting a new pipeline as the merge request is close enough to the target branch.
...
### Community contributions[](https://docs.gitlab.com/development/code_review/#community-contributions "Permalink")
...
#### Testing community contributions locally[](https://docs.gitlab.com/development/code_review/#testing-community-contributions-locally "Permalink")
...
Replace `<MR_URL>` with the full URL to the merge request. For example: `https://gitlab.com/gitlab-org/gitlab/-/merge_requests/1234.diff`.
...
This command also runs `gdk update`, which updates your development environment. The process can take several minutes to complete.
...
#### Add the canonical project/fork as a remote[](https://docs.gitlab.com/development/code_review/#add-the-canonical-projectfork-as-a-remote "Permalink")
...
#### Taking over a community merge request[](https://docs.gitlab.com/development/code_review/#taking-over-a-community-merge-request "Permalink")
...
### The right balance[](https://docs.gitlab.com/development/code_review/#the-right-balance "Permalink")
One of the most difficult things during code review is finding the right balance in how deep the reviewer can interfere with the code created by a author.
  ...
  * Enforcing and improving [code style](https://docs.gitlab.com/development/contributing/style_guides/) should be primarily done through [automation](https://handbook.gitlab.com/handbook/values/#cleanup-over-sign-off) instead of review comments.
...
GitLab is used in a lot of places. Many users use our [Omnibus packages](https://about.gitlab.com/install/), but some use the [Docker images](https://docs.gitlab.com/install/docker/), some are [installed from source](https://docs.gitlab.com/install/self_compiled/), and there are other installation methods available. GitLab.com itself is a large Enterprise Edition instance. This has some implications:
  ...
  2. **Database migrations** must be:
    ...
    3. Categorized correctly:
       ...
       * [Post-deployment migrations](https://docs.gitlab.com/development/database/post_deployment_migrations/) run _after_ the new code is deployed, when the instance is configured to do that.
       * [Batched background migrations](https://docs.gitlab.com/development/database/batched_background_migrations/) run in Sidekiq, and should be used for migrations that [exceed the post-deployment migration time limit](https://docs.gitlab.com/development/migration_style_guide/#how-long-a-migration-should-take) GitLab.com scale.
...
### Customer critical merge requests[](https://docs.gitlab.com/development/code_review/#customer-critical-merge-requests "Permalink")
...
## Troubleshooting failing pipelines[](https://docs.gitlab.com/development/code_review/#troubleshooting-failing-pipelines "Permalink")
...
## Examples[](https://docs.gitlab.com/development/code_review/#examples "Permalink")
...
**[“Modify`DiffNote` to reuse it for Designs”](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/13703):** It contained everything from nitpicks around newlines to reasoning about what versions for designs are, how we should compare them if there was no previous version of a certain file (parent vs. blank `sha` vs empty tree).
**[“Support multi-line suggestions”](https://gitlab.com/gitlab-org/gitlab-foss/-/merge_requests/25211)** : The MR itself consists of a collaboration between FE and BE, and documenting comments from the author for the reviewer. There’s some nitpicks, some questions for information, and towards the end, a security vulnerability.
...
**[“Support multiple assignees for merge requests”](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/10161)** : A good example of collaboration on an MR touching multiple parts of the codebase. Nick pointed out interesting edge cases, James Lopez also joined in raising concerns on import/export feature.
### Credits[](https://docs.gitlab.com/development/code_review/#credits "Permalink")
